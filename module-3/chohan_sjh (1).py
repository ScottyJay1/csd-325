#Scott Hackett Module 3.2 Assignment
"""Cho-Han, by Al Sweigart al@inventwithpython.com
The traditional Japanese dice game of even-odd.
If the user's dice roll equals a 2 or a 7, they earn a 10 mon bonus
...
while True:  # Main game loop.
    ...
    #Check if User rolled a 2 or a 7
    if dice1 + dice2 == 2 or dice1 + dice2 == 7:
        print('You rolled a 2 or a 7 and earned a 10 mon bonus.')
