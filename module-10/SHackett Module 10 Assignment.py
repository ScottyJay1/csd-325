...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        todo1 = tk.Label(
            self.tasks_frame,
            text="--- Add Items Here --- (Right-click to delete a task)",
            bg="lightgrey",
            fg="black",
            pady=10
        )

        #change delete to right click
    ...
    def add_task(self, event=None):
        ...
        if len(task_text) > 0:
            ...
            #change deletion to right click
    ...
    def exit_program(self):
        if msg.askokcancel("Exit", "Are you sure you want to exit?"):
            self.destroy()
